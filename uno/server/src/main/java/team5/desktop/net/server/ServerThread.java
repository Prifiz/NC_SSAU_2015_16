                            ...
                            case "Room 2":
                                if ((rooms[1].countGamers() < 4) && (rooms[1].isPlaying() == false)) {
                                    ...
                                    if (rooms[1].countGamers() == 1) {
                                        ...
                                        dataE.writeBool(true);
                                        rooms[1].setPlaying(true);//устанавливаем, что в комнате идет игра
                                        game(1, gamer);
                                    }
                            ...
                            case "Room 3":
                                if ((rooms[2].countGamers() < 4) && (rooms[2].isPlaying() == false)) {
                                    ...
                                    if (rooms[2].countGamers() == 1) {
                                        ...
                                        dataE.writeBool(true);
                                        rooms[2].setPlaying(true);//устанавливаем, что в комнате идет игра
                                        game(2, gamer);
                                    }
                            ...
                            case "Room 4":
                                if ((rooms[3].countGamers() < 4) && (rooms[3].isPlaying() == false)) {
                                    ...
                                    if (rooms[3].countGamers() == 1) {
                                        ...
                                        dataE.writeBool(true);
                                        rooms[3].setPlaying(true);//устанавливаем, что в комнате идет игра
                                        game(3, gamer);
                                    }
