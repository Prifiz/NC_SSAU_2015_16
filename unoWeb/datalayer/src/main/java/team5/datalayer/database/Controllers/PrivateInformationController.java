...
public class PrivateInformationController extends AbstractController<PrivateInformation, String> {
    ...
    public static final String SELECT_ALL_PRIVATEINFORMATIONS = "SELECT * FROM Private_information";
    public static final String SELECT_PRIVATEINFORMATIONS_BY_LOGIN = "select * from private_information where login=? ";
    public static final String UPDATE_PRIVATEINFORMATIONS_BY_LOGIN = "update private_information "
            + "set name=?, surname=? where login=? ";
    public static final String DELETE_PRIVATEINFORMATIONS_BY_LOGIN = "delete from private_information where login=? ";
    public static final String INSERT_PRIVATEINFORMATIONS_BY_LOGIN = "insert into private_information (login, name, surname) values (?,?,?) ";
    ...
    public List<PrivateInformation> getAll() {
        ...
        PreparedStatement preparedStatement = getPrepareStatement(SELECT_ALL_PRIVATEINFORMATIONS);
        try {
    ...
    public List<PrivateInformation> getEntitiesByField(String login) {
        PreparedStatement preparedStatement = getPrepareStatement(SELECT_PRIVATEINFORMATIONS_BY_LOGIN);
        List<PrivateInformation> list = new ArrayList<PrivateInformation>();
        try {
    ...
    public boolean updateByField(PrivateInformation privateInformation, String login) {
        PreparedStatement preparedStatement = getPrepareStatement(UPDATE_PRIVATEINFORMATIONS_BY_LOGIN);
        try {
    ...
    public boolean deleteByField(String login) {
        PreparedStatement preparedStatement = getPrepareStatement(DELETE_PRIVATEINFORMATIONS_BY_LOGIN);
        try {
            preparedStatement.setString(1, login);
            preparedStatement.executeUpdate();
            return true;
    ...
    public boolean insert(PrivateInformation privateInformation, String login) {
        ...
        PreparedStatement preparedStatement = getPrepareStatement(INSERT_PRIVATEINFORMATIONS_BY_LOGIN);
        try {
            preparedStatement.setString(1, login);
